    ...
    <a-layout-header class="header" :style="{ zIndex: 1, width: '100%' }">
        <div class="sello">
            <router-link :to="{ path: '/index' }">
                <img src="../../../assets/imagenes/sello/blanco.png" alt="" width="80" height="80" />
            </router-link>
        </div>
        <div class="logo">
            <router-link :to="{ path: '/index' }">
                <img src="../../../assets/imagenes/logogenericosinletras.png" alt="logoEsicuba" width="120"
                    height="50" />
            </router-link>
        </div>
        <div class="breadc">
            <a-breadcrumb class="breadcrumb">
                <template #separator><span v-if="name != 'index'" style="color: white">></span></template>
        ...
        <div class="profile">
            <a-dropdown placement="topLeft">
                <a class="ant-dropdown-link" @click.prevent>
                    <span>
                        <img src="../../../assets/imagenes/user4.png" alt="" width="45" height="45" />
                    </span>
                </a>
                <template #overlay>
                    <a-menu>
                        <a-menu-item @click="visible = true">Cambiar contraseña</a-menu-item>
                        <a-menu-item @click="logout2">Cerrar Sesión</a-menu-item>
                    </a-menu>
                </template>
            </a-dropdown>
            <h5 v-if="userInfo.username" style="padding-left: 0.5rem;">{{
                userInfo.username[0].toLocaleUpperCase() + userInfo.username.slice(1) }}</h5>
        </div>
    </a-layout-header>
    <a-modal v-model:open="visible" title="Cambio de Contraseña" :destroyOnClose="true" :footer="null">
